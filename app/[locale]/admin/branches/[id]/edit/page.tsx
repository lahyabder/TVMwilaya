...
import { updateBranch, getBranch } from '@/actions/branch';
...
export default function EditBranchPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (!branch) return <div className="p-8">Loading...</div>;
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                <form action={updateBranchWithId as any} className="space-y-6">
                    ...
                    <div className="border-t border-gray-100 pt-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="contactName" id="contactName" defaultValue={branch.contactName || ''} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" dir="auto" />
                            </div>
                            <div>
                                <label htmlFor="contactPhone" className="block text-sm font-medium text-gray-700 mb-1">{t('contact_phone')}</label>
                                <input type="text" name="contactPhone" id="contactPhone" defaultValue={branch.contactPhone || ''} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" dir="ltr" />
                            </div>
                            <div>
                                <label htmlFor="contactEmail" className="block text-sm font-medium text-gray-700 mb-1">{t('contact_email')}</label>
                                <input type="email" name="contactEmail" id="contactEmail" defaultValue={branch.contactEmail || ''} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" dir="ltr" />
                            </div>
                            <div>
                                <label htmlFor="contactWhatsapp" className="block text-sm font-medium text-gray-700 mb-1">{t('contact_whatsapp')}</label>
                                <input type="text" name="contactWhatsapp" id="contactWhatsapp" defaultValue={branch.contactWhatsapp || ''} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition" dir="ltr" />
                            </div>
                        </div>
                    </div>
